...
$ repo init -u https://github.com/SonyAosp/platform_manifest -b android-6.0
```
...
Follow [This BuildScript](https://github.com/SonyAosp/vendor_google/blob/android-6.0/build.sh)
